  ...
  try {
    ...
    if (Math.abs(calorieDiff) <= 200) {
      ...
      insights.push({
        ...
        message: `You've exceeded your goal by ${Math.round(
          calorieDiff
        )} calories. Consider a lighter dinner or a walk.`,
      });
      score -= 10;
      ...
      insights.push({
        ...
        message: `You're under your goal by ${Math.round(
          Math.abs(calorieDiff)
        )} calories. Make sure to fuel your body!`,
      });
    ...
    if (proteinConsumed >= proteinGoal) {
      ...
      insights.push({
        ...
        title: "Low Protein",
        message:
          "Protein intake is low. Try adding chicken, eggs, or lentils to your next meal.",
      });
      score -= 10;
    ...
    if (waterIntake >= waterGoal) {
      ...
      insights.push({
        ...
        message: `You need ${Math.round(
          (waterGoal - waterIntake) / 250
        )} more glasses to hit your goal.`,
      });
      score -= 5;
