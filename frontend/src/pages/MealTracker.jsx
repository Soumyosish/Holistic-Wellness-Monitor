...
function MealTracker() {
  ...
  const handleDeleteMeal = async (id) => {
    ...
    try {
      await axios.delete(`${import.meta.env.VITE_API_URL}/api/meals/${id}`, {
        withCredentials: true,
      });
      fetchMeals();
    } catch (err) {
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end gap-4">
            <div>
              ...
              <p className="text-slate-600 text-lg">
                Log your nutrition for a healthier you.
              </p>
            </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10 animate-fade-in-up delay-100">
          {[
            ...
            <div
              key={idx}
              className={`relative overflow-hidden p-6 rounded-4xl bg-white/80 border ${stat.border} shadow-sm group hover:shadow-md transition-all`}
            >
              <div
          ...
          {meals.length > 0 ? (
            <div className="space-y-4">
              {meals.map((meal, index) => (
                <div
                  key={meal._id}
                  className="group flex flex-col md:flex-row md:items-center justify-between p-5 rounded-2xl bg-white border border-slate-100 hover:border-indigo-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] hover:shadow-[0_10px_30px_rgba(0,0,0,0.04)] transition-all duration-300"
                >
                  ...
                  <div className="flex items-center gap-6 mt-4 md:mt-0">
                    ...
                    <div className="flex gap-2">
                      {[
                        ...
                        <div
                          key={m.l}
                          className={`px-3 py-1 rounded-lg text-xs font-bold ${m.c}`}
                        >
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-slate-500 max-w-md mx-auto">
                Start tracking your nutrition by adding your first food item for
                today.
              </p>
              <button
                onClick={() => setShowAddModal(true)}
        ...
        {showAddModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            ></div>
            <div className="bg-white rounded-4xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative shadow-2xl animate-fade-in-up">
              ...
              <div className="p-8">
                ...
                <div className="mb-8">
                  ...
                  <div className="relative group">
                    ...
                    />
                    {isSearching && (
                      <div className="absolute right-4 top-4 animate-spin text-indigo-500">
                        <Utensils size={20} />
                      </div>
                    )}
                  </div>
                    ...
                    <div className="mt-2 bg-white border border-slate-100 rounded-xl shadow-xl overflow-hidden max-h-60 overflow-y-auto z-20 absolute w-[calc(100%-4rem)]">
                      {searchResults.map((food, i) => (
                        <div
                          ...
                          className="flex items-center gap-3 p-3 hover:bg-indigo-50 cursor-pointer border-b border-slate-50 last:border-0 transition-colors"
                        >
                ...
                <form onSubmit={handleAddMeal} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNewMeal({
                            ...newMeal,
                            servingQuantity: e.target.value,
                          })
                        }
                        className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 placeholder:text-slate-400 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10 outline-none"
                      />
                      ...
                      {["calories", "protein", "carbs", "fats"].map((nut) => (
                        <div key={nut} className="relative">
                          ...
                          <input
                            ...
                            value={newMeal[nut]}
                            onChange={(e) =>
                              setNewMeal({ ...newMeal, [nut]: e.target.value })
                            }
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-4 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl shadow-lg shadow-slate-200 transition-all transform hover:-translate-y-1"
                  >
              ...
              <form onSubmit={handleUpdateMeal} className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 outline-none"
                      required
                    />
                  </div>
                  <div>
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-6 py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl shadow-lg transition-all transform hover:-translate-y-1"
                  >
                    Save
                  </button>
                </div>
