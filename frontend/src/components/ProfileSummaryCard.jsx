    ...
    return (
      <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl shadow-xl p-6 border-2 border-purple-200">
        ...
        <p className="text-gray-600 mb-4">
          Set up your health profile to get personalized recommendations and track your progress.
        </p>
        <button
          onClick={() => navigate("/profile")}
          className="w-full px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-xl hover:shadow-lg transform hover:scale-105 transition-all"
        >
          Complete Profile →
        </button>
      </div>
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl p-6">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className={`p-4 rounded-xl ${bmiCategory.bg} border-2 border-opacity-20`}>
          <div className="text-sm font-semibold text-gray-600 mb-1">BMI</div>
          <div className="text-3xl font-bold text-gray-800">{profile.bmi?.toFixed(1)}</div>
        ...
        <div className="p-4 rounded-xl bg-orange-50 border-2 border-orange-200">
          <div className="text-sm font-semibold text-orange-600 mb-1">Daily Target</div>
      ...
      <div className="mt-6 pt-6 border-t-2 border-gray-100">
        <div className="text-sm font-semibold text-gray-600 mb-3">Daily Targets</div>
        <div className="grid grid-cols-3 gap-3 text-center">
          <div className="p-2 rounded-lg bg-red-50">
            <div className="text-xs text-red-600">Protein</div>
            <div className="text-lg font-bold text-red-700">{profile.dailyProteinTarget}g</div>
          </div>
          <div className="p-2 rounded-lg bg-yellow-50">
            <div className="text-xs text-yellow-600">Carbs</div>
            <div className="text-lg font-bold text-yellow-700">{profile.dailyCarbsTarget}g</div>
          </div>
          <div className="p-2 rounded-lg bg-indigo-50">
            <div className="text-xs text-indigo-600">Fats</div>
            <div className="text-lg font-bold text-indigo-700">{profile.dailyFatsTarget}g</div>
          </div>
        </div>
      </div>
    </div>
